- Hướng dẫn cài đặt trang web
    B1: Khởi động server Apache và MySQL
    B2: Import file DATABASE.sql vào server MySQL
    B3: Đưa folder WebPhuKienThuCung vào C:\xampp\htdocs\
...
- Một số tài khoản có sẵn để đăng nhập trong trang web
