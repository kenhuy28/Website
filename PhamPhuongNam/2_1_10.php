...
<body>
    ...
    <form action="" method="post">
        <table>
            ...
            <tr <?php if (!isset($_POST['themBaiHat'])) { echo "hidden"; } ?>>
                <td colspan="2">
                    <textarea name="strDSBH" rows="5" cols="60"><?php if (isset($strDSBH)) { echo $strDSBH; } ?></textarea>
                    <br>
                </td>
            </tr>
            <tr>
            ...
            <tr <?php if (!isset($_POST['hienThiBXH'])) { echo "hidden"; } ?>>
                <td colspan="2"><textarea name="strBXH" rows="5" cols="60"><?php if (isset($strBXH)) { echo $strBXH; } ?></textarea></td>
            </tr>
            </tbody>
        </table>
    </form>
