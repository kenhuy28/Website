        ...
        <table style="width: 700px;">
            ...
            <tr>
                ...
                <td><select name="maLop">
                        ...
                        <option value="62.CNTT-1" <?php if ($maLop == "62.CNTT-1")
                            echo "selected"; ?>>62.CNTT-1</option>
                        <option value="62.CNTT-2" <?php if ($maLop == "62.CNTT-2")
                            echo "selected"; ?>>62.CNTT-2</option>
                        <option value="62.CNTT-3" <?php if ($maLop == "62.CNTT-3")
                            echo "selected"; ?>>62.CNTT-3</option>
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><Textarea name="str" style="width: 100%;"><?php echo $chuoi; ?></Textarea></td>
            </tr>
